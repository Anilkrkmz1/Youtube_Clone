...
const Comments = ({ data }) => {
  ...
  return (
    <div className="my-6">
      ...
      <input className="w-full bg-transparent border-b p-2 outline-none mb-5" 
      ...
      {data.data.map((i, key) => (
        <div key={key} className="flex gap-2 items-start px-1 py-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            {i.replyCount > 0 && (
              <div className="flex w-fit items-center p-1 rounded-md cursor-pointer gap-2 text-blue-500
              hover:bg-[#36639662]">
